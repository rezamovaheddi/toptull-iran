...
export const metadata = {
  ...
  description: "ایجاد حساب کاربری در تاپ‌تول",
  robots: {
    index: false,
    follow: false,
  },
...
export default async function RegisterPage() {
  ...
  return (
    <div
      className="min-h-screen w-full flex flex-col md:flex-row bg-white overflow-hidden text-gray-900 font-sans"
      dir="rtl"
    >
      ...
      <div
        className="flex-1 flex justify-center items-start md:items-center p-4 md:p-8 
